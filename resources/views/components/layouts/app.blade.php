...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('website/plugins/font-awesome/fontawesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('website/plugins/font-awesome/brands.css') }}">
    <link rel="stylesheet" href="{{ asset('website/plugins/font-awesome/solid.css') }}">
            ...
            <div class="container">
                <a class="navbar-brand" href="index.html">
                    <img loading="prelaod" decoding="async" class="img-fluid" width="160"
                        src="{{ asset('website/images/logo.png') }}" alt="Wallet">
                </a>
